...
res58 %>%
    as.data.frame %>%
    write.csv('../data/diff_exp/DE_N258.csv', quote = FALSE)
s50 %>%
    as.data.frame %>%
    write.csv('../data/diff_exp/DE_N250_shrunken.csv', quote = FALSE)
s58 %>%
    as.data.frame %>%
    write.csv('../data/diff_exp/DE_N258_shrunken.csv', quote = FALSE)